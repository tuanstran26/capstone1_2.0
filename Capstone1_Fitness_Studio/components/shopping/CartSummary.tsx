...
//         className={`w-full py-4 rounded-full font-bold text-lg transition-all duration-300 ${totalItems > 0
      ...
      <div className="mt-4 pt-4 border-t">
        <div className="flex justify-center gap-4 items-center opacity-60">
          ...
          <div className="flex gap-2">
            ...
            <div className="w-10 h-6 bg-gray-200 rounded flex items-center justify-center text-xs font-bold">PP</div>
          </div>
        </div>
      </div>
    </motion.div>
