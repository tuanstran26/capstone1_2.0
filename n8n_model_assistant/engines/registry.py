...
import nodes.fetch_api_node_handler as fetch_api_node_handler
import nodes.body_merge_node_handler as body_merge_node_handler
...
class NodeRegistry [self]:
    def __init__(self):
        self.NODE_REGISTRY = {
            ...
            "fetch_api": fetch_api_node_handler,
            "body_merge": body_merge_node_handler
        }
